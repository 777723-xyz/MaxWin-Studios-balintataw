...
Khas.Lighting.LIGHTS = {
  ...
  flashlight: {
    ...
    intensity: 100,
    variation: 0,
    offset_x: { 2: 0, 4: 0, 6: 0, 8: 0 },
    offset_y: { 2: 0, 4: 0, 6: 0, 8: 0 },
...
Khas.Lighting.Settings.CUSTOM_BLEND_MODE =
  Khas.Lighting.PARAMETERS['Custom Blending'].toLowerCase() == 'on';
Khas.Lighting.Settings.TRANSFER_RESET =
  Khas.Lighting.PARAMETERS['Transfer Reset'].toLowerCase() == 'on';
Khas.Lighting.Settings.AUTO_BATTLE_LIGHTING =
  Khas.Lighting.PARAMETERS['Auto Battle Lighting'].toLowerCase() == 'on';
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// * PixiOutOfDate Error
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
PixiOutOfDateError.prototype.initialize = function () {
  ...
  this.message =
    'Please update your RPG Maker MV and your project js folder in order to use Khas Advanced Graphics. It requires Pixi.js v3 or later.';
...
Graphics._createRenderer = function () {
  ...
  if (typeof PIXI.BLEND_MODES != 'undefined') {
    ...
    this._renderer.state.blendModes[PIXI.BLEND_MODES.KHAS_LIGHT] = [
      gl.SRC_ALPHA,
      gl.ONE,
    ];
    this._renderer.state.blendModes[PIXI.BLEND_MODES.KHAS_LIGHTING] = [
      gl.ZERO,
      gl.SRC_COLOR,
    ];
  } else {
...
// * Game Map
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Object.defineProperty(Game_Map.prototype, 'lighting', {
  get: function () {
    return this._lighting;
  },
});
Object.defineProperty(Game_Map.prototype, 'battleLighting', {
  get: function () {
    return this._battleLighting;
  },
});
Object.defineProperty(Game_Map.prototype, 'tileLights', {
  get: function () {
...
Game_Map.prototype.kal_callKhasTilesetCommand =
  Game_Map.prototype.callKhasTilesetCommand;
...
Game_Map.prototype.khasSetupMap = function () {
  ...
  this._tileLights = [];
  if (Khas.Lighting.Settings.TRANSFER_RESET)
    this._lighting.setAmbientLight('ffffffff');
    ...
    case 'ambient_light':
      ...
      if (switchId > 0) {
        if ($gameSwitches.value(switchId))
          this._lighting.setAmbientLight(target);
      } else {
        if (this._lighting.autoAmbientLight)
          this._lighting.setAmbientLight(target);
      }
      break;
    case 'region_light':
    ...
    for (var y = 0; y < this.height(); y++) {
      ...
      if (h > 0 && h % 2 == 0) {
        if (this.getHeight(x, y + 1) < h) {
          ...
          while (
            this.isValid(x, y + dy) &&
            this.getHeight(x, y + dy) > this.getHeight(x - 1, y + dy) &&
            this.isWall(x, y + dy)
          ) {
            dy += 1;
          }
        ...
        if (this.getHeight(x, y - 1) < h)
          this.addCaster(x, y, new Khas_SCFT(x, y, h));
        if (this.getHeight(x - 1, y) < h)
          this.addCaster(x, y, new Khas_SCFL(x, y, h));
        if (this.getHeight(x + 1, y) < h)
          this.addCaster(x, y, new Khas_SCFR(x, y, h));
      }
      if (!(this._shadowCasters[x][y].length > 0))
        this._shadowCasters[x][y] = null;
    }
  }
};
...
// * Game CharacterBase
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Object.defineProperty(Game_CharacterBase.prototype, 'light_id', {
  get: function () {
    return this._light_id;
  },
});
Object.defineProperty(Game_CharacterBase.prototype, 'light_ox', {
  get: function () {
    return this._light_ox;
  },
});
Object.defineProperty(Game_CharacterBase.prototype, 'light_oy', {
  get: function () {
    return this._light_oy;
  },
});
Object.defineProperty(Game_CharacterBase.prototype, 'light_size', {
  get: function () {
    return this._light_size;
  },
});
Object.defineProperty(Game_CharacterBase.prototype, 'light_transition', {
  get: function () {
    return this._light_transition;
  },
});
Object.defineProperty(Game_CharacterBase.prototype, 'cast_shadows', {
  get: function () {
    return this._cast_shadows;
  },
});
Game_CharacterBase.prototype.kal_initialize =
  Game_CharacterBase.prototype.initialize;
...
Game_CharacterBase.prototype.lightScreenX = function () {
  return Math.round(
    ($gameMap.adjustX(this._realX) + 0.5) * $gameMap.tileWidth() +
      $gameScreen.shake()
  );
};
Game_CharacterBase.prototype.lightScreenY = function () {
  return Math.round(
    ($gameMap.adjustY(this._realY) + 0.5) * $gameMap.tileHeight()
  );
};
...
// * Game Interpreter
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Game_Interpreter.prototype.kal_pluginCommand =
...
Game_Interpreter.prototype.pluginCommand = function (command, args) {
  ...
  switch (command.toLowerCase()) {
    ...
    case 'setactorlight':
      ...
      if (actorId && lightId)
        $gameMap.battleLighting.setBattlerLight(
          'actor',
          actorId,
          lightId,
          ox,
    ...
    case 'battlelighting':
      ...
      switch (battleCommand.toLowerCase()) {
        ...
        case 'ambientlight':
          ...
          if (!(target.length == 6 || target.length == 8))
        ...
        case 'addlight':
          ...
          var y = Number(args[3] || '');
          if (Khas.Lighting.LIGHTS[lightId]) {
            $gameMap.battleLighting.addLightPoint(
              new Game_LightPoint(x, y, lightId)
            );
          } else {
            alert(
              'Light not found: ' + lightId + '\nCheck your plugin commands.'
            );
          }
          break;
      }
...
Object.defineProperty(Game_Lighting.prototype, 'lightPoints', {
  get: function () {
    return this._lightPoints;
  },
});
Object.defineProperty(Game_Lighting.prototype, 'battlerLightIds', {
  get: function () {
    return this._battlerLightIds;
  },
});
...
Game_Lighting.prototype.setAmbientLight = function (target, time) {
  if (typeof target == 'string') {
    color = /^#?([a-f\d]{2})?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(
      target
    );
    if (color) {
...
Game_Lighting.prototype.setBattlerLight = function (
  type,
  battlerId,
  lightId,
  offset_x,
...
// * Game LightPoint
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
function Game_LightPoint() {
  this.initialize.apply(this, arguments);
}
Object.defineProperty(Game_LightPoint.prototype, 'light_id', {
  get: function () {
    return this._light_id;
  },
});
Object.defineProperty(Game_LightPoint.prototype, 'light_ox', {
  get: function () {
    return this._light_ox;
  },
});
Object.defineProperty(Game_LightPoint.prototype, 'light_oy', {
  get: function () {
    return this._light_oy;
  },
});
Object.defineProperty(Game_LightPoint.prototype, 'light_size', {
  get: function () {
    return this._light_size;
  },
});
Object.defineProperty(Game_LightPoint.prototype, 'light_transition', {
  get: function () {
    return this._light_transition;
  },
});
Object.defineProperty(Game_LightPoint.prototype, 'cast_shadows', {
  get: function () {
    return this._cast_shadows;
  },
});
...
// * Game LightTile
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
function Game_LightTile() {
  this.initialize.apply(this, arguments);
}
Object.defineProperty(Game_LightTile.prototype, 'light_id', {
  get: function () {
    return this._light_id;
  },
});
Object.defineProperty(Game_LightTile.prototype, 'light_ox', {
  get: function () {
    return this._light_ox;
  },
});
Object.defineProperty(Game_LightTile.prototype, 'light_oy', {
  get: function () {
    return this._light_oy;
  },
});
Object.defineProperty(Game_LightTile.prototype, 'light_size', {
  get: function () {
    return this._light_size;
  },
});
Object.defineProperty(Game_LightTile.prototype, 'light_transition', {
  get: function () {
    return this._light_transition;
  },
});
Object.defineProperty(Game_LightTile.prototype, 'cast_shadows', {
  get: function () {
    return this._cast_shadows;
  },
});
...
Game_LightTile.prototype.lightScreenX = function () {
  return Math.round(
    $gameMap.adjustX(this._realX) * $gameMap.tileWidth() + $gameScreen.shake()
  );
};
...
// * Game LightBattler
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
function Game_LightBattler() {
  this.initialize.apply(this, arguments);
}
Object.defineProperty(Game_LightBattler.prototype, 'light_id', {
  get: function () {
    return this._light_id;
  },
});
Object.defineProperty(Game_LightBattler.prototype, 'light_ox', {
  get: function () {
    return this._light_ox;
  },
});
Object.defineProperty(Game_LightBattler.prototype, 'light_oy', {
  get: function () {
    return this._light_oy;
  },
});
Object.defineProperty(Game_LightBattler.prototype, 'light_size', {
  get: function () {
    return this._light_size;
  },
});
Object.defineProperty(Game_LightBattler.prototype, 'light_transition', {
  get: function () {
    return this._light_transition;
  },
});
Object.defineProperty(Game_LightBattler.prototype, 'cast_shadows', {
  get: function () {
    return this._cast_shadows;
  },
});
...
Game_LightBattler.prototype.findLightProperties = function () {
  if (this._battler) {
    ...
    var lightProperties =
      $gameMap.battleLighting.battlerLightIds[this._type][id];
    if (lightProperties) {
...
Game_LightBattler.prototype.registerLight = function () {
  if ($khasGraphics.lighting && this._light_id)
    $khasGraphics.lighting.addCharacter(this);
};
...
Object.defineProperty(Sprite_Light.prototype, 'id', {
  get: function () {
    return this._id;
  },
});
Object.defineProperty(Sprite_Light.prototype, 'screenX', {
  get: function () {
    return this._screenX;
  },
});
Object.defineProperty(Sprite_Light.prototype, 'screenY', {
  get: function () {
    return this._screenY;
  },
});
Object.defineProperty(Sprite_Light.prototype, 'h', {
  get: function () {
    return this._h;
  },
});
Object.defineProperty(Sprite_Light.prototype, 'character', {
  get: function () {
    return this._character;
  },
});
Object.defineProperty(Sprite_Light.prototype, 'shadow', {
  get: function () {
    return this._shadow;
  },
});
Sprite_Light.prototype.initialize = function (character) {
  ...
  this.blendMode = Khas.Lighting.Settings.CUSTOM_BLEND_MODE
    ? PIXI.BLEND_MODES.KHAS_LIGHT
...
Sprite_Light.prototype.initializeLight = function (id) {
  ...
  if (this._syncWithDirection && typeof this._ox != 'object')
    this._ox = { 2: this._ox, 4: this._ox, 6: this._ox, 8: this._ox };
  if (this._syncWithDirection && typeof this._oy != 'object')
    this._oy = { 2: this._oy, 4: this._oy, 6: this._oy, 8: this._oy };
...
Sprite_Light.prototype.setRendering = function (castShadows) {
  ...
  if (this._castShadows) {
    ...
    this._renderedLight = new PIXI.RenderTexture.create(
      this._width,
      this._height
    );
...
Sprite_Light.prototype.update = function () {
  this.refreshLight();
  if (this.isValid()) {
    if (this._character_shadows != this._character.cast_shadows)
...
Sprite_Light.prototype.refreshShadows = function () {
  if (
    this._character._realX == this._last_crx &&
    this._character._realY == this._last_cry
  )
    return;
  ...
  if (
    this._screenX < -hw ||
    this._screenY < -hh ||
    this._screenX > Graphics.width + hw ||
    this._screenY > Graphics.height + hh
  )
    return;
...
// * Spriteset Battle
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Spriteset_Battle.prototype.kal_initializeKhasGraphics =
  Spriteset_Battle.prototype.initializeKhasGraphics;
...
// * Khas Ambient Light
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
function Khas_AmbientLight() {
  this.initialize.apply(this, arguments);
}
Object.defineProperty(Khas_AmbientLight.prototype, 'intensity', {
  get: function () {
    return this._intensity;
  },
});
Object.defineProperty(Khas_AmbientLight.prototype, 'red', {
  get: function () {
    return this._red;
  },
});
Object.defineProperty(Khas_AmbientLight.prototype, 'green', {
  get: function () {
    return this._green;
  },
});
Object.defineProperty(Khas_AmbientLight.prototype, 'blue', {
  get: function () {
    return this._blue;
  },
});
...
// * Khas Graphics
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Object.defineProperty(Khas_Graphics.prototype, 'lighting', {
  get: function () {
    return this._lighting;
  },
});
Khas_Graphics.prototype.kal_loadResources =
  Khas_Graphics.prototype.loadResources;
  ...
  for (var i = 0; i < lightNames.length; i++) {
    ...
    if (light_data.syncWithDirection) {
      Khas.Lighting.cache[lightNames[i]] = {
        2: (Khas.Lighting.cache[lightNames[i]] = ImageManager.loadLight(
          '' + light_data.fileName + '_2'
        )),
        4: (Khas.Lighting.cache[lightNames[i]] = ImageManager.loadLight(
          '' + light_data.fileName + '_4'
        )),
        6: (Khas.Lighting.cache[lightNames[i]] = ImageManager.loadLight(
          '' + light_data.fileName + '_6'
        )),
        8: (Khas.Lighting.cache[lightNames[i]] = ImageManager.loadLight(
          '' + light_data.fileName + '_8'
        )),
      };
    } else {
      Khas.Lighting.cache[lightNames[i]] = ImageManager.loadLight(
        light_data.fileName
      );
    }
  }
...
Khas_Graphics.prototype.newScene = function () {
  ...
  switch (this._spriteset.khasType()) {
    ...
    case 'battle':
      if (Khas.Lighting.Settings.AUTO_BATTLE_LIGHTING)
        $gameMap.battleLighting.copyAmbientLight($gameMap.lighting);
...
// * Khas Lighting
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
function Khas_Lighting() {
  this.initialize.apply(this, arguments);
}
Object.defineProperty(Khas_Lighting.prototype, 'layerSprite', {
  get: function () {
...
Khas_Lighting.prototype.initialize = function (lightingState) {
  ...
  this._lightMap = new PIXI.RenderTexture.create(
    Graphics.width,
    Graphics.height
  );
...
Khas_LightingFilter.prototype.initialize = function () {
  Khas_Filter.prototype.initialize.call(
    this,
...
// * Khas Shadow
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
function Khas_Shadow() {
  this.initialize.apply(this, arguments);
}
Object.defineProperty(Khas_Shadow.prototype, 'mask', {
  get: function () {
    return this._mask;
  },
});
...
Khas_ShadowCaster.prototype.screenX = function (x) {
  return Math.round(
    $gameMap.adjustX(x) * $gameMap.tileWidth() + $gameScreen.shake()
  );
};
...
Khas_SCFT.prototype.cast = function (light) {
  ...
  sx2 -= light.screenX;
  sy -= light.screenY;
  if (sy > 0 || light.h >= this._h)
    light.shadow.cast(sx1, sy, sx2, sy, light.scale.x);
};
...
Khas_SCFL.prototype.cast = function (light) {
  ...
  sy1 -= light.screenY;
  sy2 -= light.screenY;
  if (sx > 0 || light.h >= this._h)
    light.shadow.cast(sx, sy1, sx, sy2, light.scale.x);
};
